...
class AuthAccountGw {
  public async list(args: any) {
    ...
    const result = await queryGraphQL({
      ...
      query: `
        query AccountList($filter: AccountFilter, $params: PaginationAndSortig) {
  ...
  public async update(accountId: string, params: any) {
    const result = await queryGraphQL({
      ...
      query: `
        mutation AccountUpdate($where: AccountWhereInput, $params: AccountInput) {
