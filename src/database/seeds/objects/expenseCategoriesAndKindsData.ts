...
const COMFORT_CLEANING = {
  ...
  expenseKinds: [
    { id: 501, orderNo: 10, code: 'CAR_WASH_FULL', canSchedule: false, langs: { en: 'Car wash (full)', ru: 'Мойка (полная)', fr: 'Lavage auto (complet)', es: 'Lavado de auto (completo)' } },
    { id: 502, orderNo: 20, code: 'CAR_WASH_INTERIOR', canSchedule: false, langs: { en: 'Car wash (interior)', ru: 'Мойка (салон)', fr: 'Lavage auto (intérieur)', es: 'Lavado de auto (interior)' } },
    { id: 503, orderNo: 30, code: 'CAR_WASH_EXTERIOR', canSchedule: false, langs: { en: 'Car wash (exterior)', ru: 'Мойка (снаружи)', fr: 'Lavage auto (extérieur)', es: 'Lavado de auto (exterior)' } },
    { id: 504, orderNo: 40, code: 'CAR_WASH_WHEELS', canSchedule: false, langs: { en: 'Car wash (wheels)', ru: 'Мойка (колеса)', fr: 'Lavage auto (roues)', es: 'Lavado de auto (ruedas)' } },
    { id: 505, orderNo: 50, code: 'CAR_WASH_TRUNK', canSchedule: false, langs: { en: 'Car wash (trunk)', ru: 'Мойка (багажник)', fr: 'Lavage auto (coffre)', es: 'Lavado de auto (maletero)' } },
    { id: 506, orderNo: 60, code: 'CAR_WASH_ENGINE_BAY', canSchedule: false, langs: { en: 'Car wash (engine bay)', ru: 'Мойка (моторный отсек)', fr: 'Lavage auto (compartiment moteur)', es: 'Lavado de auto (compartimiento del motor)' } },
    { id: 507, orderNo: 70, code: 'CAR_WASH_UNDERBODY', canSchedule: false, langs: { en: 'Car wash (underbody)', ru: 'Мойка (низ машины)', fr: 'Lavage auto (dessous de caisse)', es: 'Lavado de auto (parte inferior)' } },
    { id: 508, orderNo: 80, code: 'DETAILING', canSchedule: false, langs: { en: 'Detailing', ru: 'Детейлинг', fr: 'Detailing', es: 'Detallado' } },
...
const COMMON = {
  ...
  expenseKinds: [
    { id: 301, orderNo: 10, code: 'AUTO_INSURANCE', canSchedule: false, langs: { en: 'Auto insurance', ru: 'Автомобильная страховка', fr: 'Assurance auto', es: 'Seguro de auto' } },
    { id: 306, orderNo: 20, code: 'PARKING', canSchedule: false, langs: { en: 'Parking', ru: 'Парковка', fr: 'Stationnement', es: 'Estacionamiento' } },
    { id: 312, orderNo: 30, code: 'TOLLS', langs: { en: 'Tolls', ru: 'Платная дорога', fr: 'Péages', es: 'Peajes' } },
    { id: 309, orderNo: 40, code: 'FINANCING_LEASING', canSchedule: false, langs: { en: 'Financing/Leasing payment', ru: 'Оплата кредита/лизинга', fr: 'Paiement financement/leasing', es: 'Pago de financiamiento/leasing' } },
    { id: 302, orderNo: 50, code: 'TECHNICAL_INSPECTION', canSchedule: false, langs: { en: 'Technical inspection', ru: 'Техническая инспекция', fr: 'Contrôle technique', es: 'Inspección técnica' } },
    { id: 303, orderNo: 60, code: 'EMISSIONS_INSPECTION', canSchedule: false, langs: { en: 'Emissions inspection', ru: 'Инспекция на эмиссии', fr: 'Contrôle des émissions', es: 'Inspección de emisiones' } },
    ...
    { id: 304, orderNo: 80, code: 'LICENSE_PLATE_PAYMENT', canSchedule: false, langs: { en: 'Payment for license plate', ru: 'Оплата за номерные знаки', fr: "Paiement plaque d'immatriculation", es: 'Pago de placa de matrícula' } },
    { id: 307, orderNo: 90, code: 'TAXES', canSchedule: false, langs: { en: 'Taxes', ru: 'Налог', fr: 'Taxes', es: 'Impuestos' } },
    ...
    { id: 308, orderNo: 110, code: 'MEMBERSHIPS', canSchedule: false, langs: { en: 'Memberships (CAA, AMA, etc.)', ru: 'Членские взносы', fr: 'Adhésions (clubs auto, etc.)', es: 'Membresías (clubes de auto, etc.)' } },
...
const CONSUMABLES = {
  ...
  expenseKinds: [
    ...
    { id: 601, orderNo: 30, code: 'ADDITIVES_REFILL', canSchedule: false, langs: { en: 'Refilling additives', ru: 'Заправка присадки', fr: "Remplissage d'additifs", es: 'Recarga de aditivos' } },
